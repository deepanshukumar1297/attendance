...
<body class="row align-content-between" style="background-color: rgb(233, 235, 221); height:100vh; width: 100vw;">
            ...
            <div class="col-6 border border-primary rounded bg-info">
                ...
                <div class="row my-3">
                    <div class="col text-light">
                        ...
                        class="form-control" value="<%=section_name%>" required readonly>
                    </div>	
                </div>
    ...
    <script>
        ...
        function fire(e) {
        if (document.getElementById("section_id").value !== "<%= section_id %>" || document.getElementById("section_name").value !== "<%= section_name %>") {
        ...
        var url="AdminSectionDelete?section_id=<%=section_id %>";
        console.log(url);
