			...
			<div class="row justify-content-center">
				<div class="col-5 border border-primary rounded bg-info">
					...
					<div class="row bg-primary">
						<div class="col text-monospace">
							<header class="text-center font-weight-bold my-3">ADD NEW STUDENT</header>
						</div>
					</div>
					...
					<div class="row">
						<div class="col text-light">
							...
							placeholder="Name Of The Student" class="form-control" required>
						</div>	
					</div>
...
<script>
	...
	function fire(e) {
	if (document.getElementById("student_sectionId").value== "choose section" || document.getElementById("student_id").value== "" || document.getElementById("student_name").value== "") {
	...
	var url="AdminStudent?student_name="+student_name+"&student_id="+student_id+"&student_sectionId="+student_sectionId;
	...
	xhr.onload = function () {
		if (this.status == 200) {
			...
			if(res=="0")
			   {
				document.getElementById("response").innerHTML="Student added";
				}
			if(res=="1")
			   {
